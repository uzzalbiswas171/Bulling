                 ...
                 padding: EdgeInsets.only(left: 15),
                  ...
                  Expanded(
                    child:ListTile(
                        ...
                        title: CustomTText(text: "Uzzal Biswas", fontSize: 15, fontWeight: FontWeight.w600, textcolor: customTextC),
                        subtitle: CustomTText(text: "uzzal.biswas.cse@gmail.com", fontSize: 15, fontWeight: FontWeight.w600, textcolor: customTextC),
                    ),
                  ),
                ],
              ),
